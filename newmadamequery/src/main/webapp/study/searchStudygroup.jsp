...
<nav>
	<ul id="main-menu">
		...
		<li><a href="#">STUDYGROUP</a>
			<ul id="sub-menu">
				<li><a href="#">�ㅽ�곕�� �깅�</a></li>
				<li><a href="#">�ㅽ�곕�� 寃���</a></li>
				<li><a href="#">�ㅽ�곕�� 洹몃９ 蹂닿린</a></li>
			</ul>
		</li>
...
<div id="search">
	...
	<form name="form" method="POST" action="<c:url value='/studyGroup/search' />">
		<table id= "searchGroup">
			...
			<tr>
				<td>�ㅽ�곕�� 洹몃９ 紐�</td>
				<td><input type="text" name="groupName" value="ex)��怨�由ъ�" onFocus="this.value='' " /></td>
				<td>湲곌�</td>
				<td><select name="term">
					<option>1媛���</option>
					<option>3媛���</option>
			...
			<tr>
				<td>��媛�</td>
				<td colspan="3"><textarea name="description" cols="70" rows="2" onFocus="this.value='' ">媛��⑦�� ��媛�湲��� ���ν���몄��</textarea> </td>
			</tr>
			<tr>
				<td>�ㅽ�곕�� 諛⑹��</td>
			...
			<tr>
				...
				<td>����</td>
				<td>userId (������  userId 媛��몄�ㅺ린)</td>
			</tr>
		</table>
		<br><br>
		<input type="button" id="createB" value="寃�����湲�" onClick="<c:url value= '/studyGroup/search '>
